/**
 * Download Careers page images from Figma.
 * Usage: set FIGMA_ACCESS_TOKEN=... && node scripts/download-careers-images.mjs
 */
...
const OUT_DIR = path.join(process.cwd(), "public/images/careers");

const ASSETS = [
  { nodeId: "2020:1089", file: "careers-hero.jpg" },
  { nodeId: "2020:1160", file: "careers-culture.jpg" },
  { nodeId: "2020:1151", file: "careers-culture-visual.png", format: "png" },
];
