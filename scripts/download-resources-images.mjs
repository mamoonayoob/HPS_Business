/**
 * Download Resources page images from Figma.
 * Usage: set FIGMA_ACCESS_TOKEN=... && node scripts/download-resources-images.mjs
 */
...
const ASSETS = [{ nodeId: "2020:1264", file: "resources-hero.jpg" }];
