export const CAREERS_HERO = {
  badge: "JOIN OUR TEAM",
  titleLead: "CAREERS AT",
  titleAccent: "HPS",
  subtitle:
    "We are a dynamic and fast-growing company in the Middle East, committed to offering exceptional career opportunities for ambitious individuals.",
  ...
  perks: [
    {
      ...
      title: "CAREER GROWTH",
      description:
        "Regular training, seminars, and workshops to stay ahead.",
    },
    {
      number: "02",
      title: "TEAMWORK",
      description:
        "Engaging cultural activities that build lasting connections.",
    },
    {
      number: "03",
      title: "EXCELLENCE",
      description: "A progressive environment where talent thrives.",
    },
  ],
  image: "/images/careers/careers-culture.jpg",
  visualImage: "/images/careers/careers-culture-visual.png",
};

export const CAREERS_APPLICATION = {
  badge: "APPLICATION PORTAL",
  titleLead: "CURRENT",
  titleAccent: "OPENINGS",
  subtitle: "Take the next step in your career. Submit your application below.",
  cities: ["Riyadh", "Jeddah", "Dammam", "Makkah", "Medina"],
  departments: [
    "Operations",
    "Logistics",
    "Warehouse",
